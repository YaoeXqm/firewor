...
function (a) {
    ...
    c.DEFAULTS = {
        ...
        if (a instanceof Array)
            for (var b in a) this.$element.data("danmuList")[a[b].time] ? this.$element.data("danmuList")[a[b].time].push(a[b]) : (this.$element.data("danmuList")[a[b].time] = [], this.$element.data("danmuList")[a[b].time].push(a[b]));
